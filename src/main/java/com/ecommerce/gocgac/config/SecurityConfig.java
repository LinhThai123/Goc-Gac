    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Public News endpoints (tin tức đã đăng)
                .requestMatchers("/api/news/public/**", "/api/news-categories/public/**").permitAll()
                // Public System config (chỉ cấu hình is_public)
                .requestMatchers("/api/system-configs/public").permitAll()
                // Public Affiliate tracking (ghi click + redirect)
                .requestMatchers("/api/affiliate/track/**").permitAll()
                // Public Ads & Banner (hiển thị + ghi click)
                .requestMatchers("/api/ads/public/**", "/api/ads/track/**", "/api/banners/public/**").permitAll()
                // Public Recommendation endpoints (sản phẩm liên quan)
